...
@Composable
fun Weather(selectedWeatherAdjective: String?, onWeatherSelected: (String?) -> Unit){
    Column (Modifier.fillMaxSize()){
        WeatherFeedback(selectedWeatherAdjective, onWeatherSelected)
    }
}

@Composable
fun WeatherFeedback(selectedWeatherAdjective: String?, onWeatherSelected: (String?) -> Unit) {
    ...
    Column {
        Row (horizontalArrangement = Arrangement.Center, verticalAlignment = Alignment.CenterVertically, modifier = Modifier
            ...
            Text(text = "How was the weather?", fontSize = 30.sp)
        }
            ...
            Row(horizontalArrangement = Arrangement.Start, verticalAlignment = Alignment.CenterVertically,
                modifier = Modifier
                    ...
                    .selectable(
                        ...
                        onClick = {
                            onWeatherSelected (if (selectedWeatherAdjective == adjective) {
                                null
                            } else {
                                adjective
                            })
